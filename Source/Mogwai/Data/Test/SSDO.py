...
def render_graph_DefaultRenderGraph():
    ...
    g.addEdge('ForwardLightingPass.color', 'SSDO.colorIn')
    g.addEdge('ForwardLightingPass.depth', 'SSDO.depth')
    g.addEdge('ForwardLightingPass.normals', 'SSDO.normals')
    g.addEdge('SSDO.colorOut', 'ColorMapPass.input')
    g.markOutput('SSDO.colorOut')
    return g
